...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnBehind = findViewById<Button>(R.id.btnBehind)
    ...
    private fun askForRestart(){
        ...
        builder.run {
            ...
            val nListener =DialogInterface.OnClickListener {dialog: DialogInterface?, which: Int ->
                finish()
            }
            setNegativeButton(android.R.string.cancel, nListener)
